...
public class Display extends javax.swing.JFrame {
    public ArrayList<Objeto> lista = new ArrayList<>();
    public int page = 1;
    ...
    private void initComponents() {
        ...
        criarUsuario.setText("Criar Objeto");
    ...
    private void criarUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_criarUsuarioActionPerformed
        ...
        String s1 = rad.nextInt(1000)+"";
        String s2 = rad.nextInt(100000)+"";
        int i = rad.nextInt(33);
        Objeto p = new Objeto(s1, s2, i);
        lista.add(p);
    ...
    public void atualizarPagina() {
        ...
        for(int i = 0; i < 8;i++){
           ...
           labels[i].setText("vazio");
           }else {
                labels[i].setText("<html> string 1: " + lista.get(user).getString() +
                "<br/> String 2: " + lista.get(user).getString2() +
                "<br/>int: " +lista.get(user).integer +
                "<br/>user: "+ user);
                }
       }
